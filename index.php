...
include_once __DIR__ . '/src/classes/Auth.php';
include_once __DIR__ . '/src/classes/UsuarioModel.php';
include_once __DIR__ . '/src/classes/BancoDados.php';
include_once __DIR__ . '/src/cadastro.php';
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <!-- Formulário de Login -->
        <form id="loginForm" class="space-y-4" method="POST" action="src/login.php">
            <div>
                <label for="loginEmail" class="block mb-1">Email</label>
                <input type="email" id="loginEmail" class="w-full px-3 py-2 border rounded-md" required name="email">
            </div>
            <div>
                <label for="loginPassword" class="block mb-1">Senha</label>
                <input type="password" id="loginPassword" class="w-full px-3 py-2 border rounded-md" required name="senha">
            </div>
        ...
        <form id="registerForm" class="space-y-4 hidden" method="POST" action="src/cadastro.php">
            <div>
                <label for="registerName" class="block mb-1">Nome</label>
                <input type="text" id="registerName" class="w-full px-3 py-2 border rounded-md" required name="nome">
            </div>
            <div>
                <label for="registerEmail" class="block mb-1">Email</label>
                <input type="email" id="registerEmail" class="w-full px-3 py-2 border rounded-md" required name="email">
            </div>
            <div>
                <label for="registerPhone" class="block mb-1">Telefone</label>
                <input type="tel" id="registerPhone" class="w-full px-3 py-2 border rounded-md" required name="telefone">
            </div>
            <div>
                <label for="registerCPF" class="block mb-1">CPF</label>
                <input type="text" id="registerCPF" class="w-full px-3 py-2 border rounded-md" required name="cpf">
            ...
            <div>
                ...
                <input type="password" id="registerPassword" class="w-full px-3 py-2 border rounded-md" required name="senha">
            </div>
            <div>
                <label for="confirmPassword" class="block mb-1">Confirmar Senha</label>
                <input type="password" id="confirmPassword" class="w-full px-3 py-2 border rounded-md" required name="confirmarSenha">
            </div>
